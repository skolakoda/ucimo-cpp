...
char grid[20][41] = {"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
                     "X          c                           X",
                     "X                                      X",
                     "X                                      X",
                     "X                                      X",
...
void print_score(int, int, int, int, int, int, int);
...
int main()
{
    ...
    while (1)
    {
        ...
        print_arena();
        print_score(uhealth, chealth, bullets, qtyofboomerang, qtyofwall, boost, nofboost);
        ///time delay
        Sleep(70);
        ///user bullets
        for (i = 0; i < 20; i++)
    ...
    print_win(winner); ///selects the winner. 0 : no winner, 1 : user wins, 2 : cpu wins
    return 0;
}
...
void print_score(int uhealth, int chealth, int ubullets, int uboomerang, int uwall, int boost, int nofboost)
{
    HANDLE out;
    out = GetStdHandle(STD_OUTPUT_HANDLE);
